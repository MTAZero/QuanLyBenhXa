...
{
    public partial class FrmBaoCaoPhanLoaiSucKhoe : MetroForm
    {

        #region Hàm khởi tạo
        public FrmBaoCaoPhanLoaiSucKhoe()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void btnXuatBaoCao_Click(object sender, EventArgs e)
        {
            ...
            FrmRpTongHopPhanLoaiSucKhoe form = new FrmRpTongHopPhanLoaiSucKhoe(dateTuNgay.DateTime, dateDenNgay.DateTime);
            this.Hide();
            form.ShowDialog();
            this.Close();
        }
