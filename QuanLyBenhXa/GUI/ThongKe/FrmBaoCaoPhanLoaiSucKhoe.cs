...
{
    public partial class FrmBaoCaoPLSKCanBoCaoCap : MetroForm
    {

        #region Hàm khởi tạo
        public FrmBaoCaoPLSKCanBoCaoCap()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void btnXuatBaoCao_Click(object sender, EventArgs e)
        {
            ...
            FrmDanhSachPhanLoaiSucKhoeCanBoCaoCap form = new FrmDanhSachPhanLoaiSucKhoeCanBoCaoCap(dateTuNgay.DateTime, dateDenNgay.DateTime);
            this.Hide();
            form.ShowDialog();
            this.Close();
        }
