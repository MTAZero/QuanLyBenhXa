...
{
	/// <summary>
	/// Data access layer class for DONVI
	/// </summary>
	class DONVISql : DataLayerBase 
	{
		...
		public bool Insert(DONVI businessObject)
		{
			...
			sqlCommand.CommandText = "dbo.[DONVI_Insert]";
			...
			{				
				return false;//throw new Exception("DONVI::Insert::Error occured.", ex);
			}
			finally
			{			
        ...
        public List<DONVI> SelectAllEntities()
        {
            SqlCommand sqlCommand = new SqlCommand();
            sqlCommand.CommandText = "dbo.[DONVI_SelectAll]";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {                
                return null;//throw new Exception("DONVI::SelectAll::Error occured.", ex);
            }
            finally
            {
                MainConnection.Close();
        ...
        public List<DONVI> SelectByField(string fieldName, object value)
        {

            SqlCommand sqlCommand = new SqlCommand();
            sqlCommand.CommandText = "dbo.[DONVI_SelectByField]";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {
                return null;//throw new Exception("DONVI::SelectByField::Error occured.", ex);
            }
            finally
            {
        ...
        {
            SqlCommand sqlCommand = new SqlCommand();
            sqlCommand.CommandText = "dbo.[DONVI_DeleteByPrimaryKey]";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {
                return false;//throw new Exception("DONVI::DeleteByKey::Error occured.", ex);
            }
            finally
            {                
                MainConnection.Close();
        ...
        {
            SqlCommand sqlCommand = new SqlCommand();
            sqlCommand.CommandText = "dbo.[DONVI_DeleteByField]";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            {                
                return false;//throw new Exception("DONVI::DeleteByField::Error occured.", ex);
            }
            finally
            {             
                MainConnection.Close();
